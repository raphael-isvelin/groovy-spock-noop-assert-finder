...
public class Constants {
    ...
    public static final List<String> GROOVY_METHOD_WITH_NON_ASSERTING_CLOSURE_PARAMS_RETURNING_BOOLEAN = List.of("allMatch", "anyMatch", "every", "any", "count", "find", "findAll", "retainAll", "removeAll", "split", "takeWhile", "dropWhile", "findIndexOf", "findLastIndexOf", "findIndexValues");
