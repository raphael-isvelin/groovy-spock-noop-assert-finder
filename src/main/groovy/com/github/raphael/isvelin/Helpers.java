...
public class Helpers {
    ...
    public static String addMetaDataToSourceCode(String sourceCode) {
        return sourceCode
            .replaceAll("given:", "println \"" + GIVEN_BLOCK_TAG + "\"; given:")
            .replaceAll("setup:", "println \"" + GIVEN_BLOCK_TAG + "\"; setup:")
            .replaceAll("cleanup:", "println \"" + GIVEN_BLOCK_TAG + "\"; cleanup:")
            .replaceAll("when:", "println \"" + WHEN_BLOCK_TAG + "\"; when:")
            .replaceAll("then:", "println \"" + THEN_BLOCK_TAG + "\"; then:")
            .replaceAll("expect:", "println \"" + EXPECT_BLOCK_TAG + "\"; expect:")
            .replaceAll("where:", "println \"" + WHERE_BLOCK_TAG + "\"; where:")
            .replaceAll("def[ \t]+['\"]?setup['\"]?", "def setup")
            .replaceAll("def[ \t]+['\"]?cleanup['\"]?", "def cleanup")
            .replaceAll("void[ \t]+['\"]?setup['\"]?", "void setup")
            .replaceAll("void[ \t]+['\"]?cleanup['\"]?", "void cleanup")
            .replaceAll("def[ \t]+\"", "def \"" + TEST_CASE_BLOCK_TAG)
            .replaceAll("def[ \t]+'", "def '" + TEST_CASE_BLOCK_TAG)
            .replaceAll("void[ \t]+\"", "void \"" + TEST_CASE_BLOCK_TAG)
            .replaceAll("void[ \t]+'", "void '" + TEST_CASE_BLOCK_TAG)
        ;
    }
